...
export default function Services() {
  ...
  return (
    <>
      <Helmet>
        <title>Stop the Leak! 24/7 Emergency Roof Repair in Nevada | Gates Enterprises</title>
        ...
        <link rel="canonical" href="https://www.gatesroofingvegas.com/services" />
      </Helmet>
      <Stack
        sx={{
          '> div > div > img': {
        ...
        <Grid container backgroundColor='white'>
          ...
          <Grid item xs={12} lg={6} className={slideFromRight} sx={{
            ...
            <Typography variant="body1" color="black">
              Our team lives, works and knows Nevada weather and this understanding of
          ...
          <Grid item xs={12} lg={6} sx={{
            ...
            <div ref={refUnderlayment} className={useIsVisible(refUnderlayment) ? slideFromLeft : null}>
              ...
              <Typography variant="body1" color="black">
                ...
                leaks due to harsh Nevada weather.
              </Typography>
              <Typography variant="h4" color="primary.main">
                Ventilation
              </Typography>
