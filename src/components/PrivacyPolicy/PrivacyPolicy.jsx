  ...
  return (
    <div style={{ padding: '8em' }}>
      ...
      <ul>
        ...
        <li>
          <p><strong>Website</strong> refers to Gates Enterprises Website, accessible from <a href="www.gatesmontana.com" rel="external nofollow noopener" target="_blank">www.gatesmontana.com</a></p>
        </li>
        <li>
