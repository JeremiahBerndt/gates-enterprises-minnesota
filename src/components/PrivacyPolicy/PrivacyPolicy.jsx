  ...
  return (
    <div style={{ padding: '8em' }}>
      ...
      <ul>
        ...
        <li>
          <p><strong>Website</strong> refers to Gates Enterprises Website, accessible from <a href="www.gatesminnesota.com" rel="external nofollow noopener" target="_blank">www.gatesminnesota.com</a></p>
        </li>
        <li>
