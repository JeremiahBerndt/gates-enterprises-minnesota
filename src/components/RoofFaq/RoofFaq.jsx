  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="FAQs, blog, and information on roofing, hail, and insurance in Minnesota." />
        <link rel="canonical" href="https://www.gatesminnesota.com/roof-faq" />
      </Helmet>
      <Stack
        sx={{
          '> div > div > img': {
