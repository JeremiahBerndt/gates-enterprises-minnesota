  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="FAQs, blog, and information on roofing, hail, and insurance in Montana." />
        <link rel="canonical" href="https://www.gatesmontana.com/roof-faq" />
      </Helmet>
      <Stack
        sx={{
          '> div > div > img': {
