  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="FAQs, blog, and information on roofing, hail, and insurance in Nevada." />
        <link rel="canonical" href="https://www.gatesroofingvegas.com/roof-faq" />
      </Helmet>
      <Stack
        sx={{
          '> div > div > img': {
